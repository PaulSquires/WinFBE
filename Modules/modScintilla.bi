...
Type Sci_RangeToFormat Field = 4
   hdc       As uLong                ' Sci_SurfaceID hdc
   hdcTarget As uLong                ' Sci_SurfaceID hdcTarget
...
' NOTE: code should be DWORD, but it is defined as LONG in PBWin 9 built-in NMHDR structure
' // Size = 12 bytes
