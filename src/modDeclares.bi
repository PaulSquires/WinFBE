...
Enum
   ...
   MSG_USER_DESIGNTAB_CHANGING
   MSG_USER_DESIGNTAB_CHANGED
   ...
   IDM_MRU, IDM_MRUFILES, IDM_OPENINCLUDE, IDM_COMMAND, IDM_KEYBOARDSHORTCUTS
   ...
   IDM_SELECTLINE, IDM_SPACESTOTABS, IDM_TABSTOSPACES
   ...
   '' VIEW
   IDM_VIEW_START
   IDM_VIEW, IDM_VIEWEXPLORER, IDM_VIEWOUTPUT, IDM_FUNCTIONLIST
...
dim shared as HWnd HWND_FRMMAIN_MENUBAR, HWND_FRMMAIN_TOPTABS, HWND_FRMMAIN_TOPTABS_SHADOW, HWND_FRMTOPTABS_HSCROLLBAR 
dim shared as HWnd HWND_FRMEXPLORER, HWND_FRMEXPLORER_LISTBOX, HWND_FRMEXPLORER_VSCROLLBAR
...
Dim Shared As HWnd HWND_FRMFUNCTIONLIST, HWND_FRMFUNCTIONLIST_LISTBOX, HWND_FRMBUILDCONFIG, HWND_FRMMENUEDITOR, HWND_FRMUSERTOOLS
...
dim shared as wstring * 10 _
   ...
   wszPreserveCase, wszReplace, wszReplaceAll, wszMoreActions
